...
public:
    ...
    void onConnect(NimBLEClient* pClient) override {Serial.println("Connected to the server.");}
...
void BLEClientMulti::init() {
    ...
    addTargetDevice(DUMPER1_MAC);   
    addTargetDevice(DUMPER2_MAC);   
    addTargetDevice(DUMPER3_MAC);   
